...
! photosynthesis variables
           ...
           call getConfigREAL  ('vmfact_hw','pft',i,rval,texist)
           if(texist) vmfact_hw = real(rval)
           call getConfigREAL  ('vmfact_co','pft',i,rval,texist)
           if(texist) vmfact_co = real(rval)
...
!! PHOTOSYNTHESIS
        ...
        call putConfigREAL("vmfact_hw",   vmfact_hw)
        call putConfigREAL("vmfact_co",   vmfact_co)
