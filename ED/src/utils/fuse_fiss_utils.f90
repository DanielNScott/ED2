...
module fuse_fiss_utils
   ...
   subroutine fuse_2_cohorts(cpatch,donc,recc, newn,green_leaf_factor,can_prss,can_shv,lsl &
      ...
      if (c13af > 0) then
         cpatch%balive_c13           (recc) = cpatch%balive_c13          (recc) * rnplant  &
                                            + cpatch%balive_c13          (donc) * dnplant
         cpatch%broot_c13            (recc) = cpatch%broot_c13           (recc) * rnplant  &
                                            + cpatch%broot_c13           (donc) * dnplant
         cpatch%bsapwooda_c13        (recc) = cpatch%bsapwooda_c13       (recc) * rnplant  &
                                            + cpatch%bsapwooda_c13       (donc) * dnplant
         cpatch%bsapwoodb_c13        (recc) = cpatch%bsapwoodb_c13       (recc) * rnplant  &
                                            + cpatch%bsapwoodb_c13       (donc) * dnplant
         cpatch%bstorage_c13         (recc) = cpatch%bstorage_c13        (recc) * rnplant  &
         ...
         cpatch%root_maintenance_c13 (recc) = cpatch%root_maintenance_c13(recc) * rnplant  &
                                            + cpatch%root_maintenance_c13(donc) * dnplant
         cpatch%leaf_drop_c13        (recc) = cpatch%leaf_drop_c13       (recc) * rnplant  &
                                            + cpatch%leaf_drop_c13       (donc) * dnplant
      end if
      !------------------------------------------------------------------------------------!
      ...
      if (cpatch%phenology_status(recc) /= -2) then
         ...
         if (c13af > 0) then
            cpatch%bleaf_c13(recc)  = rnplant * cpatch%bleaf_c13(recc)                     &
                                    + dnplant * cpatch%bleaf_c13(donc)
         end if
      else
         cpatch%bleaf(recc)      = 0.
         if (c13af > 0) then
      ...
      if (c13af > 0) then
         cpatch%leaf_growth_resp_c13(recc)  = newni *                                      &
                                 ( cpatch%leaf_growth_resp_c13(recc) *cpatch%nplant(recc)  &
                                 + cpatch%leaf_growth_resp_c13(donc) *cpatch%nplant(donc)  )
         cpatch%root_growth_resp_c13(recc)  = newni *                                      &
                                 ( cpatch%root_growth_resp_c13(recc) *cpatch%nplant(recc)  &
                                 + cpatch%root_growth_resp_c13(donc) *cpatch%nplant(donc)  )
         cpatch%sapa_growth_resp_c13(recc)  = newni *                                      &
                                 ( cpatch%sapa_growth_resp_c13(recc) *cpatch%nplant(recc)  &
                                 + cpatch%sapa_growth_resp_c13(donc) *cpatch%nplant(donc)  )
         cpatch%sapb_growth_resp_c13(recc)  = newni *                                      &
                                 ( cpatch%sapb_growth_resp_c13(recc) *cpatch%nplant(recc)  &
                                 + cpatch%sapb_growth_resp_c13(donc) *cpatch%nplant(donc)  )
         cpatch%leaf_storage_resp_c13(recc) = newni *                                      &
                                 ( cpatch%leaf_storage_resp_c13(recc) *cpatch%nplant(recc) &
                                 + cpatch%leaf_storage_resp_c13(donc) *cpatch%nplant(donc) )
         cpatch%root_storage_resp_c13(recc) = newni *                                      &
                                 ( cpatch%root_storage_resp_c13(recc) *cpatch%nplant(recc) &
                                 + cpatch%root_storage_resp_c13(donc) *cpatch%nplant(donc) )
         cpatch%sapa_storage_resp_c13(recc) = newni *                                      &
                                 ( cpatch%sapa_storage_resp_c13(recc) *cpatch%nplant(recc) &
                                 + cpatch%sapa_storage_resp_c13(donc) *cpatch%nplant(donc) )
         cpatch%sapb_storage_resp_c13(recc) = newni *                                      &
                                 ( cpatch%sapb_storage_resp_c13(recc) *cpatch%nplant(recc) &
                                 + cpatch%sapb_storage_resp_c13(donc) *cpatch%nplant(donc) )
      ...
      if (.not. fuse_initial) then
         ...
         if (c13af > 0) then
            ...
            cpatch%fmean_leaf_growth_resp_c13(recc) = cpatch%fmean_leaf_growth_resp_c13(recc) &
                                                    * rnplant                                 &
                                                    + cpatch%fmean_leaf_growth_resp_c13(donc) &
                                                    * dnplant
            cpatch%fmean_root_growth_resp_c13(recc) = cpatch%fmean_root_growth_resp_c13(recc) &
                                                    * rnplant                                 &
                                                    + cpatch%fmean_root_growth_resp_c13(donc) &
                                                    * dnplant
            cpatch%fmean_sapa_growth_resp_c13(recc) = cpatch%fmean_sapa_growth_resp_c13(recc) &
                                                    * rnplant                                 &
                                                    + cpatch%fmean_sapa_growth_resp_c13(donc) &
                                                    * dnplant
            cpatch%fmean_sapb_growth_resp_c13(recc) = cpatch%fmean_sapb_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%fmean_sapb_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%fmean_leaf_storage_resp_c13(recc)= cpatch%fmean_leaf_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%fmean_leaf_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%fmean_root_storage_resp_c13(recc)= cpatch%fmean_root_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%fmean_root_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%fmean_sapa_storage_resp_c13(recc)= cpatch%fmean_sapa_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%fmean_sapa_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%fmean_sapb_storage_resp_c13(recc)= cpatch%fmean_sapb_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%fmean_sapb_storage_resp_c13(donc) &
                                                    * dnplant
      ...
      if (writing_long .and. (.not. fuse_initial)) then
         ...
         if (c13af > 0) then
            ...
            cpatch%dmean_root_resp_c13   (recc) = ( cpatch%dmean_root_resp_c13   (recc)       &
                                                  ...
                                                  * cpatch%nplant                (donc) )     &
                                                * newni
            cpatch%dmean_leaf_growth_resp_c13(recc) = cpatch%dmean_leaf_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_leaf_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%dmean_root_growth_resp_c13(recc) = cpatch%dmean_root_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_root_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%dmean_sapa_growth_resp_c13(recc) = cpatch%dmean_sapa_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_sapa_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%dmean_sapb_growth_resp_c13(recc) = cpatch%dmean_sapb_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_sapb_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%dmean_leaf_storage_resp_c13(recc)= cpatch%dmean_leaf_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_leaf_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%dmean_root_storage_resp_c13(recc)= cpatch%dmean_root_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_root_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%dmean_sapa_storage_resp_c13(recc)= cpatch%dmean_sapa_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_sapa_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%dmean_sapb_storage_resp_c13(recc)= cpatch%dmean_sapb_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%dmean_sapb_storage_resp_c13(donc) &
                                                    * dnplant
      ...
      if (writing_eorq .and. (.not. fuse_initial)) then
         ...
         if (c13af > 0) then
            ...
            cpatch%mmean_root_resp_c13   (recc) = ( cpatch%mmean_root_resp_c13   (recc)       &
                                                  ...
                                                  * cpatch%nplant                (donc) )     &
                                                * newni
            cpatch%mmean_leaf_growth_resp_c13(recc) = cpatch%mmean_leaf_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_leaf_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%mmean_root_growth_resp_c13(recc) = cpatch%mmean_root_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_root_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%mmean_sapa_growth_resp_c13(recc) = cpatch%mmean_sapa_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_sapa_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%mmean_sapb_growth_resp_c13(recc) = cpatch%mmean_sapb_growth_resp_c13(recc)  &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_sapb_growth_resp_c13(donc)  &
                                                    * dnplant
            cpatch%mmean_leaf_storage_resp_c13(recc)= cpatch%mmean_leaf_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_leaf_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%mmean_root_storage_resp_c13(recc)= cpatch%mmean_root_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_root_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%mmean_sapa_storage_resp_c13(recc)= cpatch%mmean_sapa_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_sapa_storage_resp_c13(donc) &
                                                    * dnplant
            cpatch%mmean_sapb_storage_resp_c13(recc)= cpatch%mmean_sapb_storage_resp_c13(recc) &
                                                    * rnplant                                  &
                                                    + cpatch%mmean_sapb_storage_resp_c13(donc) &
                                                    * dnplant
