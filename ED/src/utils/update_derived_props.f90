...
subroutine update_cohort_extensive_props(cpatch,aco,zco,mult)
   ...
   cohortloop: do ico=aco,zco
      ...
      cpatch%gpp_pot            (ico) = cpatch%gpp_pot            (ico) * mult
      cpatch%gpp_lightmax       (ico) = cpatch%gpp_lightmax       (ico) * mult
      cpatch%gpp_moistmax       (ico) = cpatch%gpp_moistmax       (ico) * mult
      cpatch%gpp_mlmax          (ico) = cpatch%gpp_mlmax          (ico) * mult
      cpatch%today_npp          (ico) = cpatch%today_npp          (ico) * mult
      cpatch%today_npp_pot      (ico) = cpatch%today_npp_pot      (ico) * mult
      cpatch%today_npp_lightmax (ico) = cpatch%today_npp_lightmax (ico) * mult
      cpatch%today_npp_moistmax (ico) = cpatch%today_npp_moistmax (ico) * mult
      cpatch%today_npp_mlmax    (ico) = cpatch%today_npp_mlmax    (ico) * mult
      cpatch%growth_resp         (ico) = cpatch%growth_resp         (ico) * mult
      cpatch%growth_resp_pot     (ico) = cpatch%growth_resp_pot     (ico) * mult
