...
subroutine init_pft_photo_params()
   ...
   use physiology_coms , only: iphysiol                & ! intent(in)
                             ...
                             , q10_c4                  ! ! intent(in)
   !--- DS Addnl Uses ---------------------------------------------------------------------!
   use physiology_coms , only: vmfact_co               & ! intent(in)
                             , vmfact_hw               ! ! intent(in)
   implicit none
   !---------------------------------------------------------------------------------------!
...
subroutine ed_params_dependents()
   ...
   !---------------------------------------------------------------------------------------!
   ! DS: Inserted this re-assignment of Vm0 so that I could read in vmfact_c3 and vmfact_c4
   ! from xml... a bit of a hack, but intended to be temporary...
...
!==========================================================================================!
!==========================================================================================!
subroutine init_iso_coms()
   use isotopes, only : cri_bleaf         & ! intent(inout)
                      , cri_broot         & ! intent(inout)
                      , cri_bsapwooda     & ! intent(inout)
                      , cri_bsapwoodb     & ! intent(inout)
                      , cri_bstorage      & ! intent(inout)
                      , cri_bdead         ! ! intent(inout)
   implicit none
   !---------------------------------------------------------------------------------------!
   ! Carbon-ratio initialization factors for plant tissues; d13C = -27 permil
   !---------------------------------------------------------------------------------------!
   cri_bdead    (:) = 0.010931/(1.0 + 0.010931)
   cri_bleaf    (:) = 0.010931/(1.0 + 0.010931)
   cri_broot    (:) = 0.010931/(1.0 + 0.010931)
   cri_bsapwooda(:) = 0.010931/(1.0 + 0.010931)
   cri_bsapwoodb(:) = 0.010931/(1.0 + 0.010931)
   cri_bstorage (:) = 0.010931/(1.0 + 0.010931)
   !---------------------------------------------------------------------------------------!
   
end subroutine init_iso_coms
!==========================================================================================!
!==========================================================================================!
