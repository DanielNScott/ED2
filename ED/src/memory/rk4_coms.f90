...
module rk4_coms
   ...
   type rk4patchtype
      ...
      real(kind=8), pointer, dimension(:) :: leaf_storage_resp_c13 !            [µmol/m²/s]
      real(kind=8), pointer, dimension(:) :: root_storage_resp_c13 !            [µmol/m²/s]
      real(kind=8), pointer, dimension(:) :: sapa_storage_resp_c13 !            [µmol/m²/s]
      real(kind=8), pointer, dimension(:) :: sapb_storage_resp_c13 !            [µmol/m²/s]
