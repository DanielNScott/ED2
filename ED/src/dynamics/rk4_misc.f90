...
subroutine copy_patch_init_carbon(sourcesite,ipa,targetp)
   ...
   do ico = 1,cpatch%ncohorts
      ...
      if (c13af > 0) then
         ...
         targetp%leaf_growth_resp_c13(ico) = dble(cpatch%leaf_growth_resp_c13 (ico))       &
                                           * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
         targetp%root_growth_resp_c13(ico) = dble(cpatch%root_growth_resp_c13 (ico))       &
                                           * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
         targetp%sapa_growth_resp_c13(ico) = dble(cpatch%sapa_growth_resp_c13 (ico))       &
                                           * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
         targetp%sapb_growth_resp_c13(ico) = dble(cpatch%sapb_growth_resp_c13 (ico))       &
                                           * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)

         targetp%leaf_storage_resp_c13(ico) = dble(cpatch%leaf_storage_resp_c13 (ico))     &
                                            * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
         targetp%root_storage_resp_c13(ico) = dble(cpatch%root_storage_resp_c13 (ico))     &
                                            * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
         targetp%sapa_storage_resp_c13(ico) = dble(cpatch%sapa_storage_resp_c13 (ico))     &
                                            * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
         targetp%sapb_storage_resp_c13(ico) = dble(cpatch%sapb_storage_resp_c13 (ico))     &
                                            * targetp%nplant(ico) / (day_sec8 * umol_2_kgC8)
      end if
   end do
